...
int main()
{
	...
	int sock_raw = socket( AF_PACKET , SOCK_RAW , htons(ETH_P_ALL)) ;  //this will capture evry incoming and outgoing packets
...
void ProcessPacket(unsigned char* buffer, int size)
{
	...
	switch (iph->protocol) //Check the Protocol and do accordingly...
	{
		...
		default: //Some Other Protocol like ARP etc.
			++others;
			break;
		// values of other protocol can be taken from web
	}
